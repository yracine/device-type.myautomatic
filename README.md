...
# 5) Under the ST mobile app, execute MyAutomaticServiceMgr (MarketSpace>Smartapps>MyApps)
...
Go to https://graph.api.smartthings.com/device/list    (or whatever your shard is)
